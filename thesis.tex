...
It looks reasonable but at least the corresponding sampling the rule need to be modified to adapt to parallel environment.
...
All these trouble lays on the point that the original procedure is not designed specifically for parallel environment at all. It's time to redesign R\&S procedures and we will introduce two revised procedures which are more suitable in parallel environment, in the next section.
